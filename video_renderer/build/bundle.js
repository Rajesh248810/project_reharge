...
const DueReminderVideo = ({ name, price, date, lang }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const slideUp = (0,esm.spring)({
    frame,
    fps,
    config: { damping: 12 }
  });
  const glowScale = (0,esm.interpolate)(
    Math.sin(frame / 10),
    [-1, 1],
    [0.98, 1.02]
  );
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              transform: `translateY(${(0,esm.interpolate)(slideUp, [0, 1], [600, 0])}px) scale(${glowScale})`,
              opacity,
              display: "flex",
              flexDirection: "column",
              alignItems: "center",
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "60px", fontWeight: "bold", color: "#fbbf24" }, children: "!" })
                }
              ),
              /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { textAlign: "center", marginBottom: "50px" }, children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { style: { fontSize: "32px", margin: 0, letterSpacing: "4px", color: "#fbbf24", fontWeight: 800 }, children: title }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)("h1", { style: { fontSize: "46px", margin: "15px 0 0 0", fontWeight: 700, color: "#f3f4f6" }, children: subtitle })
              ] }),
              /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "30px", borderBottom: "1px solid rgba(255,255,255,0.04)", paddingBottom: "20px" }, children: [
                      /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "26px", color: "#9ca3af", fontWeight: 600 }, children: nameLabel }),
                      /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "28px", color: "#ffffff", fontWeight: 700 }, children: name })
                    ] }),
                    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "30px", borderBottom: "1px solid rgba(255,255,255,0.04)", paddingBottom: "20px" }, children: [
                      /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "26px", color: "#9ca3af", fontWeight: 600 }, children: priceLabel }),
                      /* @__PURE__ */ (0,jsx_runtime.jsxs)("span", { style: { fontSize: "34px", color: "#f87171", fontWeight: 800 }, children: [
                        "Rs. ",
                        price
                      ] })
                    ] }),
                    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", paddingBottom: "10px" }, children: [
                      /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "26px", color: "#9ca3af", fontWeight: 600 }, children: dateLabel }),
                      /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "28px", color: "#fbbf24", fontWeight: 700 }, children: date })
                    ] })
                  ]
                }
              ),
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: "CABLE OPERATOR NETWORK"
          }
        )
      ]
    }
...
;// ./src/ReceiptVideo.tsx



const ReceiptVideo_waitForFont = (0,esm.delayRender)();
const ReceiptVideo_font = new FontFace(
  "Noto Sans Oriya",
  "url(https://fonts.gstatic.com/s/notosansoriya/v26/x3djYyEw-HivM_1bXU91nN_44z-u0D0z.woff2)"
);
ReceiptVideo_font.load().then(() => {
  document.fonts.add(ReceiptVideo_font);
  (0,esm.continueRender)(ReceiptVideo_waitForFont);
}).catch(() => {
  (0,esm.continueRender)(ReceiptVideo_waitForFont);
});
const ReceiptVideo = ({ name, price, date, lang }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              opacity: (0,esm.interpolate)(frame, [0, 80], [1, 0])
            }
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              opacity: (0,esm.interpolate)(frame, [0, 90], [1, 0])
            }
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "90px", fontWeight: "bold", color: "#34d399", transform: "translateY(-2px)" }, children: "\u2713" })
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { textAlign: "center", marginBottom: "50px", opacity }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { style: { fontSize: "32px", margin: 0, letterSpacing: "4px", color: "#34d399", fontWeight: 800 }, children: title }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("h1", { style: { fontSize: "46px", margin: "15px 0 0 0", fontWeight: 700, color: "#ffffff" }, children: subtitle })
        ] }),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              padding: "60px",
              boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.5)",
              transform: `translateY(${(0,esm.interpolate)(slideUp, [0, 1], [600, 0])}px)`,
              opacity,
              display: "flex",
              flexDirection: "column",
              backdropFilter: "blur(10px)"
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "35px", borderBottom: "1px solid rgba(255,255,255,0.04)", paddingBottom: "20px" }, children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "26px", color: "#9ca3af", fontWeight: 600 }, children: nameLabel }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "28px", color: "#ffffff", fontWeight: 700 }, children: name })
              ] }),
              /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "35px", borderBottom: "1px solid rgba(255,255,255,0.04)", paddingBottom: "20px" }, children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "26px", color: "#9ca3af", fontWeight: 600 }, children: priceLabel }),
                /* @__PURE__ */ (0,jsx_runtime.jsxs)("span", { style: { fontSize: "36px", color: "#34d399", fontWeight: 800 }, children: [
                  "Rs. ",
                  price
                ] })
              ] }),
              /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "35px", borderBottom: "1px solid rgba(255,255,255,0.04)", paddingBottom: "20px" }, children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "26px", color: "#9ca3af", fontWeight: 600 }, children: dateLabel }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "28px", color: "#60a5fa", fontWeight: 700 }, children: date })
              ] }),
              /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", paddingBottom: "10px" }, children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "26px", color: "#9ca3af", fontWeight: 600 }, children: "Status:" }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "24px", color: "#34d399", fontWeight: 800, textTransform: "uppercase", letterSpacing: "1px" }, children: statusLabel })
              ] })
            ]
          }
        ),
...
(0,esm.registerRoot)(VideoCompositions);
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(750), __webpack_require__.e(372), __webpack_require__.e(226)]).then(__webpack_require__.bind(__webpack_require__, 372)).then(({ StudioInternals }) => {
...
var CanvasRefForwardingFunction = ({ width, height, fit, className, style, effects }, ref) => {
  ...
  const draw = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async (imageData) => {
...
var HtmlInCanvasContent = (0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(({ width, height, effects, children, onPaint, onInit, controls, style }, ref) => {
...
var ImgInner = ({
  ...
  const getStack = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => stackRef.current, []);
  useImageInTimeline({
    src,
    displayName: name ?? null,
    id: timelineId,
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(ImgContent, {
    src,
    ...props2
  });
};
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "video_renderer:";
